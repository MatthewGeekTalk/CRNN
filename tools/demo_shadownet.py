...
def init_args():
    ...
    img_path = os.path.abspath('../data/test_images') + os.path.sep + 'test_04.jpg'
    weight_path = os.path.abspath('../model/shadownet') + os.path.sep + 'shadownet_2017-10-17-11-47-46.ckpt-199999'
